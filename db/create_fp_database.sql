...
CREATE TABLE IF NOT EXISTS `crawl_job` (
  ...
  `num_alexa_urls` int(11) NOT NULL,
  `log_file_path` varchar(4096) NOT NULL,
  `ag_type` varchar(256) NOT NULL,
  `ag_user_agent` varchar(2048) NOT NULL,
  `max_parallel_procs` int(11) NOT NULL,
  `job_dir_path` varchar(1024) NOT NULL,
  `index_html_path` varchar(1024) NOT NULL,
  `ag_binary_path` varchar(1024) NOT NULL,
  `ag_mitm_proxy` tinyint(1) NOT NULL,
  `ag_fc_fontdebug` tinyint(1) NOT NULL,
  `ag_cmd_line_options` varchar(256) NOT NULL,
